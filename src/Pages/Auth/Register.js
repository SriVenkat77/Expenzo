  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
      ...
      if (!email || !password || !name) {
        toast.error("Please fill out both email and password", toastOptions);
        return; 
      }
  ...
  return (
    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <Row>
        ...
        <h1 className="text-center text-white">Welcome to Expenzo – Your Journey to Smarter Spending Starts Here!</h1>
